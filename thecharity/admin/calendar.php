...
$desc=$_POST['description'];
  $file = time() . "_" . $_FILES['upload']['name'];
   ...
   $folder = "image/event/".$file;



$q="insert into upcoming_event(event_name,event_date,end_date,color,border_color,event_place,description,pic)values('$name','$s_date','$e_date','$color','$color','$place','$desc','$folder')";
//echo $q;
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <form method="post" action="calendar.php" enctype="multipart/form-data">
                                ...
                                <div class="input-group">
                                    <label for="eplace">Event Description</label>
                                    <textarea id="event-desc"  class="form-control" name="description" placeholder="Event Description"></textarea>
                                </div><br>
                                <!-- /btn-group -->
                                <div class="input-group">
                                    <label for="eplace">Event Pic</label>
                               <input type="file" name="upload" class="form-control" style="opacity: 1">
                                </div><br>
