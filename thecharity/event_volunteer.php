...
<head>
    ...
    <title> Event Volunteer List</title>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                            $sql="select * from event_volunteer where eh_id='$event_handler_id'";
                            ...
                            while($row=mysqli_fetch_assoc($run))

                                {
                                    ...
                                    $a=mysqli_query($conn,"select * from volunteer_register where volunteer_id='$v_id'");
                                    if($b=mysqli_fetch_assoc($a))
                                    {
                                        ...
                                        $c=mysqli_query($conn,"select * from city where c_id=$city");
                                        if($c1=mysqli_fetch_assoc($c))
                                        {
                                            $cnm=$c1['c_name'];
                                        }

                                        $d=mysqli_query($conn,"select * from area where area_id=$area");
                                        if($d1=mysqli_fetch_assoc($d))
                                        {
                                            $anm=$d1['area_name'];
                                        }
                                    }
