                ...
                <div class="row">
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        <div class="site-branding d-flex align-items-center">
                           <a class="d-block" href="index.php" rel="home"><img class="d-block" src="images/db1.png" alt="logo"></a>
                        </div><!-- .site-branding -->
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box active">
                        ...
                        <header class="entry-header">
                            <a href="vol_registration.php" style="text-decoration: none;"><h3 class="entry-title">Volunteer</h3></a>
                        </header>
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box">
                        ...
                        <header class="entry-header">
                             <a href="donor_registration.php" style="text-decoration: none;"><h3 class="entry-title">Donor</h3></a>
                        </header>
        ...
        ?>
                            ...
                            <div class="event-content-wrap">
                                <header class="entry-header d-flex flex-wrap align-items-center">
                                 <h3 class="entry-title w-100 m-0" ><a href="#" style="text-decoration: none;"><?php echo $row['event_name'];?></a></h3>

                                    <div class="posted-date">
                                        <a href="#" style="text-decoration: none;"><?php echo $row['event_date'];?></a>
                                    </div><!-- .posted-date -->

                                    <div class="cats-links">
                                        <a href="#" style="text-decoration: none;"><?php echo $row['event_place'];?></a>
                                    </div><!-- .cats-links -->
                                </header><!-- .entry-header -->
                    ...
                    <div class="milestones d-flex flex-wrap justify-content-between">
                        ...
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                ...
                                <div class="d-flex justify-content-center align-items-baseline">
                                    <div class="start-counter" data-to="06" data-speed="2000"></div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="foot-about">
                            <h2><a class="foot-logo" href="#"><img src="images/db1.png" alt=""></a></h2>
...
s1.async=true;
s1.src='https://embed.tawk.to/5c837c41c37db86fcfccd745/default';
s1.charset='UTF-8';
