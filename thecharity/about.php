        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        <header class="entry-header">
                            <h2 class="entry-title">Welcome to our Donation Hub</h2>
                        </header><!-- .entry-header -->

                        <div class="entry-content mt-5">
                            <p style="text-align: justify;">To give away money is an easy matter and in any man's power. But to decide to whom to give it, and how large and when, and for what purpose and how, is neither in every man's power nor an easy matter.Giving is not just about making a donation. It is about making a difference.</p>
                        </div><!-- .entry-content -->
                ...
                <div class="col-12 col-lg-6 order-1 order-lg-2">
                    <img src="images/Donation.jpg" alt="welcome">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
