...
if (isset($_POST['Service_pdf'])) {
    ...
    $sql = "select * from product_type where donate_type='" . $donate_name . "' and sub_categories='".$sub_type."' and city='".$city."' and area='".$area."'";
     echo $sql;
...
//    $pdf->Cell(100,8,"Place : ".$event_place1,0,1);
    ...
    $pdf->Cell(30, 10, "Donor Name", 1, 0, 'C', true);
    $pdf->Cell(25, 10, "Donate Type", 1, 0, 'C', true);
     $pdf->Cell(25, 10, "Sub Type", 1, 0, 'C', true);
    $pdf->Cell(50, 10, "Email", 1, 0, 'C', true);
    $pdf->Cell(20, 10, "City", 1, 0, 'C', true);
...
//            $pdf->Cell(20,10,$result7['city'],1,1,'C',true);
//            $k++;
//
//        }
//    }
...
if (isset($_POST['Date_pdf'])) {
    ...
    $sql4 = "select * from product_type where (date between '$start_date' and  '$end_date') ";
    ...
    while ($row4 = mysqli_fetch_assoc($res4)) {
        ...
        $sql5 = "select * from donor_register where donor_id=$donor_id";
        $res5 = mysqli_query($conn, $sql5);
        while ($row5 = mysqli_fetch_array($res5)) {
            $pdf->Cell(14, 10, $i, 1, 0, 'C', true);
            $pdf->Cell(50, 10, $row5['firstname'], 1, 0, 'C', true);
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        ...
                        <li class="active"><a href="DonorReport.php"><i class="fa fa-file-excel-o"></i> Donation Report</a></li>
                    </ul>
                </li>
            </ul>
        </section>
        ...
        <section class="content">
            ...
            <div class="register-box">
                ...
                <div class="register-box-body">
                    ...
                    <form method="post" action="DonorReport.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="Type">Select Donation type</label>
                            <select name="product_name" id="Type"
                        ...
                        <div class="form-group">
                            <label for="e_name">SELECT DONATION TYPE</label>
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-xs-12">
                                <button type="submit" name="Date_pdf" class="btn btn-primary btn-block btn-flat">
                                    Generate Date PDF
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button type="submit" name="Service_pdf" class="btn btn-primary btn-block btn-flat">
