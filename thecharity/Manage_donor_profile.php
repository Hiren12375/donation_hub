...
if(empty($_SESSION['donor']['id']))
{
    ...
    if ($row2 = mysqli_fetch_array($res2)) {
        $donor_name = $row2['firstname'];
        $donor_email = $row2['email'];
        $donor_pass = $row2['password'];
        $donor_conpass = $row2['password'];
        $donor_gender = $row2['gender'];
        $donor_contact_nos = $row2['contactno'];
        $donor_address = $row2['address'];
        $donor_city = $row2['city'];
        $donor_area = $row2['area_name'];
        $donor_birth_date = $row2['birthdate'];
        $donor_blood_group = $row2['bloodgroup'];
...
if (isset($_POST['add'])) {
    ...
    if(isset($firstname) && isset($address) && isset($mobile)  && isset($email)  && isset($password) && isset($bloodgroup)  && isset($city) && isset($area)){
        $sql1="update donor_register set firstname='$firstname',email='$email', password='$password',contactno='$mobile',address='$address',city='$city',area_name='$area',bloodgroup='$bloodgroup',gender='$gender',birthdate='$bod' where volunteer_id=".$volunteer_id;
        echo $sql1;
                ...
                <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <nav class="site-navigation d-flex justify-content-end align-items-center">
                        <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                            ...
                            <li class="current-menu-item"><a href="Manage_donor_profile.php">Manage profile</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-6 order-2 order-lg-1">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="Manage_donor_profile.php">
                        <div class="form-group">

                            <div class="form-label-group">
                                <label for="firstName">First name :- </label>
                                <input type="text" name="firstName"  class="form-control"
                                       placeholder="First name"  value="<?php if(isset($firstname)){ echo $firstname;} elseif(isset($donor_name)) { echo  $donor_name;} ?>" >
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                ...
                                <input type="text" name="inputEmail" class="form-control" placeholder="Email address" value="<?php if(isset($email)) {echo $email;} elseif(isset($donor_email)) { echo  $donor_email;} ?>">
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        ...
                                        <input type="password" name="inputPassword" class="form-control"
                                               placeholder="Password"   value="<?php if(isset($password)){ echo $password;} elseif(isset($donor_pass)) { echo  $donor_pass;} ?>">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        ...
                                        <input type="password" name="confirmPassword" class="form-control"
                                               placeholder="Confirm password"  value="<?php if(isset($conpaa)) {echo $conpaa;} elseif(isset($donor_conpass)) { echo  $donor_conpass;} ?>" >
                                    </div>
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                ...
                                <input type="text" name="inputcontactno" class="form-control"
                                       placeholder="Contact no"  value="<?php if(isset($mobile)) {echo $mobile;}  elseif(isset($donor_contact_nos)) { echo  $donor_contact_nos;}?>">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                ...
                                <textarea rows="5" name="inputAddress" class="form-control" placeholder="Address"><?php if(isset($address)) {echo $address;} elseif(isset($donor_address)) { echo  $donor_address;}?></textarea>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        ...
                                        <input type="text" name="date" class="form-control" placeholder="date" id="datetimepicker1"
                                               autocomplete="true"  value="<?php if(isset($donor_birth_date)) { echo date( "Y-m-d",strtotime($donor_birth_date));}?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-label-group">
...
<script>
    $(document).ready(function () {
        ...
        var city_id="<?php echo $donor_city ?>";
        var area_id="<?php echo $donor_area?>";
        var donor_id= "<?php  echo $donor_id?>";

        var pos = $.post("datares.php", {city_id: city_id,donor_id:donor_id,area_id:area_id});
        $("#area").empty();
        pos.done(function (data) {
            $("#area").append(data);
        });
