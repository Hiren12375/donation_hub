                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                $sql="select * from volunteer_register where is_handler=0 and is_event_volunteer=0";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="makeVol" id="makeVol" value="<?php echo $row['volunteer_id'];?>">
