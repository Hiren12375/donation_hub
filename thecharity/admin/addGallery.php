...
if(isset($_POST['add']))
{
    ...
    $desc=$_POST['desc'];
    $event_id=$_POST['ddlevent'];
    foreach ($_FILES['file']['tmp_name'] as $key=>$tmp_name){
        $file=time()."_".$_FILES['file']['name'][$key];
        $temp=$_FILES['file']['tmp_name'][$key];

        $folder="../images/gallery/".$file;
        $sql="insert into gallery (event_id,photo,description) values('$event_id','$folder','$desc')";
        

        $res=mysqli_query($conn,$sql);
            if($res && move_uploaded_file($temp,$folder)){
                echo "inserted";
            }
    }
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 text-center">
                                        <a id="logout"><i class="fa fa-sign-out"></i>&nbspSign Out</a>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </li>
        ...
        <section class="content">
            ...
            <div class="register-box">
                ...
                <div class="register-box-body">
                    <p class="login-box-msg">Add Photo Gallery</p>

                    <form method="post" action="addGallery.php" enctype="multipart/form-data">
                        <div class="custom-control has-feedback">
                            <label for="ddlevent" class="custom-control-label">SELECT EVENT:</label>
                            <select name="ddlevent" id="ddlevent" class=" custom-select custom-control">
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-xs-4">
                                <button type="submit" name="add" class="btn btn-primary btn-block btn-flat">Register
                                </button>
                            </div>
                            <!-- /.col -->
                        </div>
