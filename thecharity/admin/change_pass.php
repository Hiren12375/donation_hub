...
if (isset($_POST['change'])) {
    ...
    $sql="select * from admin_register where email='".$_SESSION['admin']['email']."'";
    $res1=mysqli_query($conn,$sql);
    $row1=mysqli_fetch_array($res1);
    $cpass1=password_verify($cpass,$row1['password']);
    echo "dec: ".$cpass1;
    $q = "update admin_register set password='$hash' where password='$cpass1'";
    echo $q;
        
    $result = mysqli_query($conn, $q);
    if ($result) {
//        header("location:Home1.php");
        echo "Change Password Sucesfully";
            ...
            <div class="register-box-body">
                ...
                <input type="text" class="form-control" name="cpass">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-xs-4">
                            <button type="submit" name="change" class="btn btn-primary btn-block btn-flat">Change
                            </button>
                        </div>
                        <!-- /.col -->
                    </div>
