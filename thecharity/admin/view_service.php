...
if (isset($_POST['add'])) {
    ...
    $sname = $_POST['sname'];
    $q = "insert into services(service_name)values('$sname')";
...
if (isset($_POST['submit'])) {
    $type = $_POST['type'];
    $sname = $_POST['sname'];
    $q = "insert into sub_services(id,sub_cat_name)values('$type','$sname')";
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <a>
                    <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#myModal"><i
        ...
        <div class="modal" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal body -->
                     <form method="post" action="view_service.php">
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                $run = mysqli_query($conn, "select * from services");
                                while ($row = mysqli_fetch_assoc($run)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-social-icon btn-dropbox" href="del_service.php?id=<?php echo $row['id']; ?>"
                                               onclick="return confirm('You sure to delete <?php echo $row['service_name']; ?>');"><i
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <button type="button" class="btn btn-block btn-primary" data-toggle="modal"
                                        data-target="#myModal1"><i class="fa fa-plus"></i>&nbsp;&nbsp;<b>Add</b>
                                </button>
                            </a>
                        </ol>
                    </section>
                        ...
                        <div class="modal" id="myModal1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header bg-light-blue">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title">Add Sub Services</h4>
                                    ...
                                    <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="mainname">Service Name</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="servicename">Sub Service Name</label>
                                                        <input type="text" class="form-control" id="servicename"
                                                               name="sname" placeholder="Enter Sub Service Name">
                                                    </div>
                                    ...
                                    <!-- Modal footer -->
                                    <div class="modal-footer">
                                        <button type="submit" name="submit"  class="btn btn-primary pull-left">Submit
                                                    </button>
                                        <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                    </div>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Sub Services</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                $run1 = mysqli_query($conn, "select * from sub_services ss ,services s where ss.id=s.id");
                                ...
                                while ($row1 = mysqli_fetch_assoc($run1)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-social-icon btn-dropbox" href="del_sub_service.php?id=<?php echo $row1['sub_id']; ?>"
                                               onclick="return confirm('You sure to delete <?php echo $row1['sub_cat']; ?>');"><i
                                                        class="fa fa-remove"></i></a>
                                        </td>
