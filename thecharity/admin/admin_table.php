...
if (isset($_POST['add']))
 {
    $sql="select * from admin_register where email='".$_POST['email']."'";
    ...
    else if(!preg_match('/^(?=.*\d)(?=.*[A-Za-z])[0-9A-Za-z!@#$%]{8,12}$/', $_POST['pass']))
    {
    ...
    else if(strcasecmp($_POST['pass'],$_POST['cpass']))
    {
    ...
    else
    {
        ...
        $folder = "image/admin/" . $file;
    }

    if(empty($err) && empty($mailerr) && empty($fileerr)  && empty($passerr) && empty($conpaaerr) && empty($birthdateerr))
    {
         ...
         $q = "insert into admin_register(fullname,email,password,contactno,dob,gender,image) values ('$fname','$email','$hash','$cno','$dob','$gender','$folder')";
         echo $q;
        $result = mysqli_query($conn, $q);
    if ($result) {
        header("location:admin_table.php");
        alert("Add Admin Sucesfully");
...
<head>
    ...
    <link rel="stylesheet"
          ...
          <style>
          .demo #name #id #pass #cpass #bdate #cno #pic{text-indent: 0px;}
          ...
          .demo .glyphicon-gift{
           ...
           .demo .glyphicon-earphone{
            position: absolute;
            top: 1px;
            left: 537px;
            font-size: 15px;
          }
          .demo .glyphicon-picture{
            position: absolute;
            top: 1px;
            left: 537px;
            font-size: 15px;
    ...
    <div class="content-wrapper">
       ...
       <!--  <section class="content-header">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i>&nbsp;&nbsp;<b>Add</b></button>
            </ol>
        ...
        <div class="modal" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal body -->
                    <form method="post" action="admin_table.php" enctype="multipart/form-data">

                    <div class="modal-body">
                    	
                    	<div class="form-group">
                           <div class="demo">
                            <input type="text" class="form-control" name="fname" placeholder="Full name" id ="name" value="<?php if(isset($firstname)) echo $firstname ?>">
                ...
                <span class="error text-danger"><?php if(isset($err)) echo "*".$err; ?></span>
                        ...
                        <div class="form-group">
                            <div class="demo">
                            <input type="password" class="form-control" name="pass" placeholder="Password" id="Password" value="<?php if(isset($password)) echo $password ?>">
                        ...
                        <div class="form-group">
                            <div class="demo">
                            <input type="password" class="form-control" name="cpass" placeholder="Confirm password" id="con_pass" value="<?php if(isset($conpaa)) echo $conpaa ?>">
                                <span  class="fa fa-fw fa-eye field-icon toggle-password" id="Show_Password"></span>
                            <span class="error text-danger"><?php if(isset($conpaaerr)) echo "*".$conpaaerr; ?></span>
                        </div>
                        </div>
                        <div class="form-group">
                            Male&nbsp;&nbsp;&nbsp;<input name="gender" type="radio" value="male" checked>&nbsp;&nbsp;
                            Female&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="female">

                        </div>
                        <div class="form-group">
                            <div class="demo">
                            <input type="date" class="form-control" name="dob" placeholder="Date of Birth" id="bdate">
                        ...
                        <div class="form-group">
                            <div class="demo">
                            <input type="text" class="form-control" name="cno" placeholder="Contact No" id="cno" value="<?php if(isset($mobile)) echo $mobile ?>">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                $run=mysqli_query($conn,"select * from admin_register");
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo $row['image'];?>" height="50" weight="50"></td>
                                </tr>
