...
if(isset($_POST['add']))
{
    ...
    $ename=$_POST['ename'];
     $edate=$_POST['edate'];
      $etime=$_POST['etime'];
      $eplace=$_POST['eplace'];
    $q="insert into upcoming_event(event_name,event_date,event_time,event_place)values('$ename','$edate','$etime','$eplace')";
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 text-center">
                                        <a href="lockscreen.php"><i class="fa fa-lock">Lock</i>&nbsp;</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
      ...
      <form method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="eventname" name="ename" placeholder="Enter Event Name">
                </div>

                <div class="form-group">
                  <label for="eventdate">Event Date</label>
                  <input type="date" class="form-control" id="eventdate" name="edate" placeholder="Enter Event Date">
                </div>

                <div class="form-group">
                  <label for="eventtime">Event Time</label>
                  <input type="time" class="form-control" id="eventtime" name="etime" placeholder="Enter Event Time">
                </div>

                <div class="form-group">
                  <label for="eventplace">Event Place</label>
                  <input type="text" class="form-control" id="eventplace" name="eplace" placeholder="Enter Event Place">
                </div>
