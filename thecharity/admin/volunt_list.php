...
//$id=$_GET['event_id'];
$id=$_SESSION['event_handler']['event_id'];
...
<div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$run=mysqli_query($conn,"select * from volunteer_register where is_handler=0");
            ...
            <form method="post" action="event_handler.php">
                ...
                <input type="submit" class="btn btn-primary" value="MAKE EVENT HANDLER " name="sub">
            </form>
