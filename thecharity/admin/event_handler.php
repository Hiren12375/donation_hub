...
if (isset($_POST['add'])) {
    ...
    $query = "select * from volunteer_register where volunteer_id=$volunteer_id";
    $res1 = mysqli_query($conn, $query);
    $row = mysqli_fetch_array($res1);
    $email = $row['email'];

//print_r($_POST);
    $q = "insert into event_handler(event_id,volunteer_id,user,pass)values('$event_id','$volunteer_id','$user','$pass')";
    $result = mysqli_query($conn, $q);
    $last_eh_id=mysqli_insert_id($conn);
    $qry = "update volunteer_register set is_handler=1 where volunteer_id=$volunteer_id";
    ...
    if ($result && $res) {
        ...
        $body = "You are registered as event-handler for the event .... please open link to accept the request " . $base_url."?event_handler_id=".$last_eh_id;
        $mail = new PHPMailer;
                            ...
                            <li class="user-footer">
                                <div class="row">
                                    <div class="col-xs-4 text-center">
                                        <a href="change_pass.php"><i class="fa fa-user"></i>&nbsp;Change Password</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
...
<li class="treeview">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Event Handler Username Password Generation
                <small></small>
            </h1>
        ...
        <!--              <h3 class="box-title">Create Event Handler</h3>-->
        <!--            </div>-->
        <!--            <div class="box-body">-->
        <!---->
        <!--               -->
        ...
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <form method="post" enctype="multipart/form-data" action="event_handler.php">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-xs-4">
                            <button type="submit" name="add" class="btn btn-primary btn-block btn-flat">Generate
                            </button>
                        </div>
                        <!-- /.col -->
                    </div>
