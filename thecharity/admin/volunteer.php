              ...
              <li class="user-footer">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="change_pass.php"><i class="fa fa-lock"></i>&nbsp;Change Password</a>                  </div>
                  <div class="col-xs-4 text-center">
      ...
      <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
        <?php
        $run=mysqli_query($conn,"select * from volunteer_register");
        ...
        <?php }?>
                ...
                <form action="volunteer_Report.php" method="post">
                    <input type="submit" name="Generate_volunteer" value="Generate Report" class="btn btn-primary">
                </form>
