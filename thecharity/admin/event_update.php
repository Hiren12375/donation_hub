   ...
   $id=$_POST['id'];
    $ename=$_POST['ename'];
     $esdate=$_POST['esdate'];
      ...
      $eplace=$_POST['eplace'];
      $edesc=$_POST['edesc'];
   $q="update upcoming_event set event_name='$ename',event_date='$esdate',event_date='$eedate',event_place='$eplace',description='$desc' where event_id=$id";
  ...
  <div class="content-wrapper">
   ...
   <div class="row">
      ...
      <form method="post">
        <?php
     $id=$_GET['id'];
       $run=mysqli_query($conn,"select * from upcoming_event where event_id=$id") ;
       $row=mysqli_fetch_assoc($run)
    ?>
              <div class="box-body">
                <div class="form-group">
                  <input type="hidden" class="form-control" id="id"  name="id" value="<?php echo $row['event_id'];?>">
                  <label for="eventname">Event Name</label>
                  <input type="text" class="form-control" id="eventname" value="<?php echo $row['event_name'];?>" name="ename" placeholder="Enter Event Name">
                </div>

                <div class="form-group">
                  <label for="eventdate">Start Date</label>
                  <input type="text" class="form-control" id="datetimepicker1" value="<?php echo $row['event_date'];?>"name="esdate" placeholder="Enter Event Date">
                </div>

                <div class="form-group">
                  <label for="eventsdate">End Date</label>
                  <input type="text" class="form-control" id="datetimepicker2" value="<?php echo $row['end_date'];?>"name="eedate" placeholder="Enter Event Date">
                </div>
                  <div class="form-group">
                  <label for="eventplace">Event Place</label>
                  <input type="text" class="form-control" id="eventplace" value="<?php echo $row['event_place'];?>"name="eplace" placeholder="Enter Event Date">
                </div>
                <div class="form-group">
                  <label for="eventplace">Event Description</label>
            <textarea  name="edesc" placeholder="Enter Event Description" class="form-control"><?php echo $row['description'];?></textarea> 
                </div>
              ...
              <div class="box-footer">
                <button type="submit" name="update" class="btn btn-primary btn-primary">UPDATE</button>
              </div>
            </form>
      </div></div></div>
