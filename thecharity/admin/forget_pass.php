...
if(isset($_POST['submit']))
{
  ...
  $qry = "select id,email,password from admin_register where email='$email'";
  ...
  $qry_ex = mysqli_query($conn,$qry);
	...
	if(mysqli_num_rows($qry_ex) > 0)
	{
      ...
      if(password_verify($pass,$rt['password']))
      {
        ...
        $_SESSION['admin']['id']=$rt['id'];
         $_SESSION['admin']['email']=$rt['email'];
    ...
    <form method="post">
     ...
     <!--  <div class="form-group has-feedback">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="submit" class="btn btn-primary btn-block danger">Submit</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
